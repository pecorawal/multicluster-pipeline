...
func homePage(w http.ResponseWriter, r *http.Request) {
	fmt.Fprintf(w, "Welcome to the HomePage! - version: BETA")
...
func initCloudsObject() {
	Clouds = []Cloud{
		...
		Cloud{Id: "5", Title: "Pecs Cloud", Desc: "IBM Cloud", Content: "IBM cloud computing is a set of cloud computing services for business offered by the information technology company IBM."},
	}
}
